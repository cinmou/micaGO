...
You need your **own** Firebase project. micaGO uses the project you create and
control.
...
> Standard FCM usage is free. Firestore is optional for URL sync, and its free tier
> is far beyond what a single small document needs.
