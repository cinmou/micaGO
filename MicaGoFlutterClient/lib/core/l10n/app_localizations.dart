...
const _strings = {
  'en': {
    ...
    'settings.testContactDesc':
        'Adds an offline contact (test@micago.cinmou). Messages you send it stay on your server and are never delivered anywhere — handy for trying out chats and notifications.',
    'settings.testContactUnreachable': 'Connect to the server to change this.',
    'settings.hiddenItems': 'Hidden items',
    'settings.hiddenItemsBody':
        'Review locally hidden content and restore selected items.',
    ...
    'settings.backupSubtitle':
        'Save your connection, appearance and preferences to a file, or restore them on a new device.',
    ...
    'notif.inAppBody':
        'Show a small card when another chat receives a message while micaGO is open.',
  ...
  'zhHans': {
    ...
    'settings.testContactDesc':
        '添加一个离线联系人(test@micago.cinmou)。你发给它的消息只留在服务器上,不会真正送达任何地方 —— 方便用来试用聊天和通知。',
    'settings.testContactUnreachable': '连接到服务器后才能更改。',
    'settings.hiddenItems': '已隐藏的内容',
    'settings.hiddenItemsBody': '查看本机隐藏的内容，并恢复选中的项目。',
    ...
    'settings.backupSubtitle': '把连接、外观和偏好设置保存到文件，或在新设备上恢复。',
    ...
    'notif.inApp': '应用内通知',
    'notif.inAppBody': 'micaGO 打开时，其他聊天收到消息会显示一张小卡片。',
  ...
  'zhHant': {
    ...
    'settings.testContactDesc':
        '新增一個離線聯絡人(test@micago.cinmou)。你傳給它的訊息只留在伺服器上,不會真正送達任何地方 —— 方便用來試用聊天與通知。',
    'settings.testContactUnreachable': '連線到伺服器後才能變更。',
    'settings.hiddenItems': '已隱藏的內容',
    'settings.hiddenItemsBody': '查看本機隱藏的內容，並還原選取的項目。',
    ...
    'settings.backupSubtitle': '將連線、外觀與偏好設定儲存為檔案，或在新裝置上還原。',
    ...
    'notif.inApp': '應用程式內通知',
    'notif.inAppBody': 'micaGO 開啟時，其他聊天收到訊息會顯示一張小卡片。',
