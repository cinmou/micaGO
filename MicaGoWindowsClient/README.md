...
当前版本已经建立 WinUI 3 双栏聊天界面和真实服务器连接链路，包括配对 JSON、LAN/Public 线路探测、Windows Credential Manager 凭据存储、会话列表、历史消息和文本发送。当前代码尚未在 Windows 上完成首次编译，因此仍属于开发中的连接版 MVP，不能视为可发布版本。
...
- UI：WinUI 3，窗口级 `MicaBackdrop`，Windows 10 自动纯色回退
- 运行时：.NET 10
