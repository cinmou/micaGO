...
public sealed partial class SettingsPage : Page
{
    ...
    private void ApplyText(){var l=AppServices.Current.Localization;PageTitle.Text=l["settings"];ConnectionHeader.Text=l["connection"];BehaviorHeader.Text=l["notifications"];NotificationLabel.Text=l["notify"];AppearanceHeader.Text=l["appearance"];ThemeLabel.Text="Theme";LanguageLabel.Text=l["language"];ContactsHeader.Text=l["contacts"];ContactsHint.Text=l["contactsHint"];ImportCsvLabel.Text=l["importCsv"];StorageHeader.Text=l["cache"];ClearCacheHint.Text=l["clearCache"];ClearCacheButton.Content=l["clear"];}
